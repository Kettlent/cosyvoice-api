...
# for i, j in enumerate(cosyvoice.inference_zero_shot('testing audio， for video app [laughter] [laughter]  ，it is working right', '', '', zero_shot_spk_id='my_zero_shot_spk', stream=False)):
